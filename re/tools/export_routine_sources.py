...
MANUAL_TRANSLATIONS = {
    ...
    **{
    ...
    ("bloodprg", 0x00149B): (
        "translated_object_heap_access",
        "mechanical translation of object-heap flag test and activity-byte increment loop",
    ),
    ("bloodprg", 0x003B45): (
    ...
    ("bloodprg", 0x005AFD): (
        "translated_vm_op_a3_collect",
        "mechanical translation of VM opcode 0xa3 word-list collection into GS:0x67f8",
    ),
    ("bloodprg", 0x005FD8): (
    ...
    ("bloodprg", 0x0065EB): (
        "translated_vm_op_a5_cond_state_array",
        "mechanical translation of VM opcode 0xa5 state-array conditional branch/store",
    ),
    ("bloodprg", 0x006023): (
    ...
    ("bloodprg", 0x00604E): (
        "translated_active_object_list_build",
        "mechanical translation of active object list builder from the GS lookup table",
    ),
    ("bloodprg", 0x006293): (
    ...
    **{
    ...
    ("bloodprg", 0x0064E5): (
        "translated_vm_op_ca_compare_var",
        "mechanical translation of VM opcode 0xca signed state compare and branch helper call",
    ),
    ("bloodprg", 0x006559): (
    ...
    ("bloodprg", 0x006596): (
        "translated_vm_op_a3_block",
        "mechanical translation of VM opcode 0xa3 conditional block handler",
    ),
    ("bloodprg", 0x006572): (
    ...
    ("bloodprg", 0x006FB9): (
        "translated_vm_op_c9_clear_record_full",
        "mechanical translation of VM opcode 0xc9 three-word record clear and reciprocal C4 teardown",
    ),
    ("bloodprg", 0x006902): (
        "translated_vm_op_shared_ae_b0_state",
        "mechanical translation of shared VM opcode 0xae/0xb0 state-table handler",
    ),
    ("bloodprg", 0x006830): (
    ...
    **{
    ...
    ("bloodprg", 0x00763E): (
        "translated_byte_parser_string_d09",
        "mechanical translation of printable-byte copy to ES:0x0d09 plus optional radio call",
    ),
    **{
        key: (
    ...
    ("bloodprg", 0x001D94): (
        "translated_vm_context_pointer_setup",
        "mechanical translation of VM context pointer setup and COD work-buffer list build",
    ),
    ("bloodprg", 0x0024B2): (
        "translated_cs_table_read_1c6",
        "mechanical translation of far decimal conversion helper using CS scratch table",
    ),
    ("bloodprg", 0x0041D1): (
    ...
    ("bloodprg", 0x00420D): (
        "translated_sprite_slot_position_update",
        "mechanical translation of active sprite-slot draw-position update and dirty flag",
    ),
    ("bloodprg", 0x004240): (
    ...
    ("bloodprg", 0x009510): (
        "translated_presentation_mode_check",
        "mechanical translation of presentation mode bucket update from DS:0x2795",
    ),
    ("bloodprg", 0x009B67): (
        "translated_ship_3d_point_cloud_randomize",
        "mechanical translation of 1000-record GS point-cloud random initializer",
    ),
    ("bloodprg", 0x009F53): (
        "translated_presentation_update_1fb2",
        "mechanical translation of presentation update gate and dirty-state stores",
    ),
    ("bloodprg", 0x002665): (
    ...
    ("bloodprg", 0x00A1F3): (
        "translated_list_d8c_iterate_epilogue",
        "mechanical translation of list iterate gate plus saved-register epilogue",
    ),
    ("bloodprg", 0x00A20C): (
        "translated_ems_list_query",
        "mechanical translation of EMS list query/count gate and callback",
    ),
    ("bloodprg", 0x00A38E): (
    ...
    ("bloodprg", 0x00A3D0): (
        "translated_queue_d8c_consume",
        "mechanical translation of variable-length queue record consume and bounds update",
    ),
    ("bloodprg", 0x00A3AD): (
    ...
    ("bloodprg", 0x00B7B0): (
        "translated_audio_param_init_cd5",
        "mechanical translation of audio parameter fill plus indirect driver callback",
    ),
    ("bloodprg", 0x00BB9D): (
