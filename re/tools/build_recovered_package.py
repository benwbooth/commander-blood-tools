...
def write_package_metadata(output: Path, records: list[dict[str, str]], cd_root: Path) -> None:
    ...
    readme = (
        ...
        "and byte-backed runtime data owners. It has passed the opening-to-bridge\n"
        "semantic gate and an input-driven DOS package gate that reaches the bridge\n"
        "while reading the complete rebuilt MANU3 overlay, but not full-game parity.\n"
