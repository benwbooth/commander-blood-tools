        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    xdb_alien_biased_state XDB_NEAR *other =
            (xdb_alien_biased_state XDB_NEAR *)(size_t)xdb_amer_slot11_cursor;

    current->field_054 = 0x64;
    if (xdb_amer_resume_pair_outside(current, other)) {
        return;
    }
    ...
    other->callback = xdb_amer_slot3_restart_initial_update;
    current->field_054 = 0;
}
