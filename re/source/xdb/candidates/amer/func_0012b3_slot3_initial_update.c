        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    ax = (xdb_u16)xdb_amer_slot3_ring[ring_index].field_000;
    bx = (xdb_u16)xdb_amer_slot3_ring[ring_index].field_002;
    dx = (xdb_u16)xdb_amer_slot3_ring[ring_index].field_004;
    ...
    if (--state->field_056 < 0) {
        ...
        random_b = random_a;
        xdb_amer_slot3_ring[ring_cursor >> 3].field_002 =
        ...
        xdb_amer_slot3_ring[ring_cursor >> 3].field_000 =
                (xdb_i16)(numerator / (xdb_i16)cx);
        state->field_056 = sar16((xdb_i16)cx, 3u);
        ax = ror3_sbb_zero(random_b);
        state->field_05c = ax;
        xdb_amer_slot3_ring[ring_cursor >> 3].field_004 =
                (xdb_i16)((ax & 0x007fu) + 8u);
        return;
    }

    ring_index = (xdb_u16)(ring_cursor >> 3);
    xdb_amer_slot3_ring[ring_index].field_000 = (xdb_i16)ax;
    xdb_amer_slot3_ring[ring_index].field_002 = (xdb_i16)bx;
    xdb_amer_slot3_ring[ring_index].field_004 = (xdb_i16)dx;

    ax = (xdb_u16)(state->field_050 & 0x0ffcu);
    if ((xdb_i16)state->position_z >= 0x3000) {
        dx = (xdb_u16)(0x0800u - (ax & 0x0ffcu));
    } else if ((xdb_i16)state->position_z <= 0) {
        dx = (xdb_u16)(0x0800u - ((ax + 0x0800u) & 0x0ffcu));
    } else if ((xdb_i16)state->position_x >= 0x1500) {
        dx = (xdb_u16)(0x0800u - ((ax - 0x0400u) & 0x0ffcu));
    } else if ((xdb_i16)state->position_x <= (xdb_i16)0xeb00u) {
        dx = (xdb_u16)(0x0800u - ((ax + 0x0400u) & 0x0ffcu));
    } else {
        goto correct_horizontal_bounds;
    }
    xdb_amer_slot3_ring[ring_index].field_002 = sar16((xdb_i16)dx, 4u);
...
correct_horizontal_bounds:
    ...
    } else if ((xdb_i16)state->position_y >= 0x0708) {
        bx = (xdb_u16)(0x0a00u - ((ax + 0x0800u) & 0x0ffcu));
    } else {
        return;
    }
    state->field_056 = 0;
    xdb_amer_slot3_ring[ring_index].field_000 = sar16((xdb_i16)bx, 3u);
}
