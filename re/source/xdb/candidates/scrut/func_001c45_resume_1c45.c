...
static void scrut_apply_object_delta(
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    *object = (xdb_i16)((xdb_u16)*object + (xdb_u16)delta);
    object = XDB_FAR_AT(xdb_i16, xdb_alien_object_segment,
            (xdb_u16)(context->object_offset + 0x035eu));
    *object = (xdb_i16)((xdb_u16)*object - (xdb_u16)delta);
    object = XDB_FAR_AT(xdb_i16, xdb_alien_object_segment,
            (xdb_u16)(context->object_offset + 0x034au));
    *object = (xdb_i16)((xdb_u16)*object + (xdb_u16)delta);
    object = XDB_FAR_AT(xdb_i16, xdb_alien_object_segment,
        ...
        xdb_alien_biased_state XDB_NEAR *other)
{
    ...
    current->field_04e = scrut_sar16((xdb_i16)(
            (xdb_u16)current->field_04e
            + (xdb_u16)(-scrut_sar16(vertical_delta, 3u))), 1u);
...
static void XDB_NEAR scrut_resume_slot3_reset_callback(
...
static void XDB_NEAR scrut_resume_slot3_ring_zero_callback(
        xdb_alien_biased_state XDB_NEAR *state,
        xdb_alien_method_context XDB_NEAR *context)
{
    xdb_u16 ring_cursor;
    ...
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_000 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_002 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_004 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_006 = 0;
}

static void XDB_NEAR scrut_resume_stage_final(
        xdb_alien_method_context XDB_NEAR *context);

static void XDB_NEAR scrut_resume_stage_timeout(
        xdb_alien_method_context XDB_NEAR *context)
{
    scrut_apply_object_delta(context);
    --xdb_scrut_slot3_timer;
    if ((xdb_i16)xdb_scrut_slot3_timer >= 0) {
        return;
    }
    context->control.resume = scrut_resume_stage_final;
}

static void XDB_NEAR scrut_resume_stage_pair(
        xdb_alien_method_context XDB_NEAR *context)
{
    xdb_alien_biased_state XDB_NEAR *current =
    ...
    average = (xdb_i16)((xdb_u16)average
            + (xdb_u16)scrut_sar16(other->field_054, 1u));
    current->field_054 = scrut_sar16(average, 1u);
    if (!scrut_pair_outside(current, other)) {
        return;
    }

    context->control.resume = scrut_resume_stage_timeout;
    current->field_054 = 0;
    other->callback = xdb_scrut_slot3_resume_callback;
    context->continuation.resume_state.value = (xdb_u16)(size_t)other;
    xdb_scrut_slot3_timer = 0x18;
}
        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    xdb_alien_biased_state XDB_NEAR *current =
            ...
            ((xdb_u8 XDB_NEAR *)context->state + XDB_ALIEN_CURSOR_BIAS);
    xdb_alien_biased_state XDB_NEAR *other =
            (xdb_alien_biased_state XDB_NEAR *)xdb_scrut_slot11_cursor;
    ...
    other->callback = scrut_resume_slot3_reset_callback;
    current->field_054 = 0;
}
        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    state->field_052 = 0;
    state->field_054 = 0;
    state->callback = scrut_resume_slot3_ring_zero_callback;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_000 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_002 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_004 = 0;
    xdb_scrut_slot3_ring[ring_cursor >> 3].field_006 = 2;
}
        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    if (queued_state == 0u) {
        ...
        xdb_scrut_slot11_queue_cursor = queue_cursor;
    ...
    context->control.resume = scrut_resume_stage_pair;
