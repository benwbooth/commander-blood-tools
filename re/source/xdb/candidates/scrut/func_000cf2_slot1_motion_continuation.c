        ...
        xdb_alien_method_context XDB_NEAR *context)
{
    ...
    state->field_010 = (xdb_i16)((xdb_u16)state->field_010 - 1u);
    ...
    distance = (xdb_i16)((xdb_u16)distance + 0x0800u);
    if (z_distance > 0x03e8) {
        goto fixed_step;
    }

    x_distance = (xdb_i16)(state->position_x + xdb_alien_view_x);
    distance = (xdb_i16)((xdb_u16)distance + 0x0400u);
    ...
    if (denominator < 0) {
        denominator = (xdb_i16)(0u - (xdb_u16)denominator);
    }
    denominator = (xdb_i16)(((xdb_u16)denominator >> 1) + 0x0010u);
...
fixed_step:
    ...
    step = (xdb_i16)(0u - (xdb_u16)sar16(
            (xdb_i16)((xdb_u16)distance - 0x0800u), 2u));

divide_step:
    numerator = (xdb_i16)((xdb_u16)step - state->ring_offset);
    state->field_05c = random;
    state->field_056 = (xdb_i16)(numerator / denominator);

advance:
    distance = (xdb_i16)((xdb_u16)state->field_056 + state->ring_offset);
    state->ring_offset = (xdb_u16)distance;
    state->field_050 = (xdb_u16)(
            state->field_050 + (xdb_u16)sar16(distance, 5u));
    cursor = (xdb_u16)((state->field_058 + 0x0080u) & 0x0ffcu);
    state->field_058 = cursor;
    sample = sar16(motion_sample(cursor), 5u);
    state->field_052 = (xdb_i16)((xdb_u16)distance + (xdb_u16)sample);
}
