        ...
        xdb_u16 raster_segment)
{
    ...
    if (width_1 == 0u) {
        ...
        raster->depth_gradient = XDB_MULTIPLY_Q16(
                ...
                reciprocal_1);
        raster->advance_offset = XDB_SCRUT_ADVANCE_REMOVE_OFFSET;
    } else {
        if (width_2 == 0u) {
            return;
        }
        ...
        if ((xdb_i16)(x_1 - x_2) > 0) {
            ...
            if ((xdb_i16)x_2 < 0) {
                ...
                raster->advance_offset = XDB_SCRUT_ADVANCE_SECONDARY_OFFSET;
            }
            ...
            if ((xdb_i16)x_1 < 0) {
                ...
                raster->advance_offset = XDB_SCRUT_ADVANCE_SWITCH_OFFSET;
            }
        } else {
            raster->advance_offset = XDB_SCRUT_ADVANCE_REMOVE_OFFSET;
        }
