...
static void cb_dos_close_direct(cb_u16 handle);
#pragma aux cb_dos_close_direct = "mov ah,3eh" "int 21h" parm [bx] modify exact [ax]
...
#include <io.h>
#define cb_dos_close_direct(handle) ((void)close((int)(handle)))
#else
