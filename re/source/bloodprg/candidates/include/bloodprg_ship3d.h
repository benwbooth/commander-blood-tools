...
#define SHIP_3D_POS_KIND_DIRECT_10 0x0010u
#define SHIP_3D_POS_KIND_DIRECT_40 0x0040u
#define SHIP_3D_OBJECT_KIND_POSITION_KIND100 0x0100u
#define SHIP_3D_POS_KIND_DIRECT_200 0x0200u

#define SHIP_3D_FIELD_SELECTOR_POSITION 0x000bu
#define SHIP_3D_KIND100_POS_MATCH_FIELD 0x0009u
#define SHIP_3D_KIND100_POS_MISMATCH_FIELD 0x000au
