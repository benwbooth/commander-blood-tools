...
#pragma aux framebuffer_noise_rect \
        parm caller [ax] [bx] [cx] [dx] modify exact [ax es]
#pragma aux framebuffer_rect_fill \
        parm caller [ax] [bx] [cx] [dx] modify exact [ax es]
...
#pragma aux fullscreen_copy_to_backbuffer parm [si] modify exact [ax]
#endif
