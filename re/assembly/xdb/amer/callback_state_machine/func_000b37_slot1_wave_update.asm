...
; provenance: internal callback selected by the AMER slot-1 wave state; the alternate path jumps to the shared camera continuation at 0x0C5D
; raw stop: 0x000BD0 (0x99 bytes)
