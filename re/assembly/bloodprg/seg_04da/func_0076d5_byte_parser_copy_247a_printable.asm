...
; label: byte_parser_copy_247a_printable
; label_comment: Byte-parser opcode 0x0A copies bytes 0x20 through 0x7F from DS:SI to ES:0x247A. It leaves the first control or high-bit byte unconsumed and writes a NUL terminator without advancing DI.
