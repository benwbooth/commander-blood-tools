...
; seg_off: 0971:027e
; group: seg_0971
; provenance: recursive_graph | stack_balance_boundary_audit
; label: resource_switch
; label_comment: full resource switch/load preparation routine. The 0x009f8e prefix saves EAX, stores the new id, closes and reinitializes the banked list, then falls through the former false 0x009fa2 split to open/read the resource, apply palette blocks, derive resource bounds, restore EAX, and return carry clear on success
; byte_count: 309
; boundary: cfg_blocks_20_terminals_1
; terminal: ret:1
; direct_callees: 0x009f80, 0x00a0c3, 0x00a141, 0x00a622, 0x00a664, 0x00a73e, 0x00a757
; indirect_calls: 1
; routine_bytes_sha256: a37330896c8ee762160d2f8d7af9867ec9361d370967044452bf92bea1918ca6
