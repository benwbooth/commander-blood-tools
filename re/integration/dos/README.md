...
handlers, `list_d8c_init`, the runtime-verified `vm_special_slot_remove` and
`lookup_table_1fb5` replacements, and `palette_upload_if_dirty`. The latter
uses a fixed 36-byte
