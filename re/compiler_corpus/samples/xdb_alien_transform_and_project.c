/* Codegen probe for the shared alien transform and projection routine. */
#include <dos.h>
...
extern volatile xdb_i32 xdb_alien_screen_center_x;
extern volatile xdb_i32 xdb_alien_screen_center_y;
extern volatile xdb_alien_projection_context XDB_NEAR
        *xdb_alien_active_projection_context;
extern volatile xdb_u16 xdb_alien_current_projection_state_offset;
extern volatile xdb_u16 xdb_alien_projection_remaining;
extern volatile xdb_u16 xdb_alien_projection_common_clip;
extern volatile xdb_u16 xdb_alien_projection_field_2280;
extern volatile xdb_i32 xdb_alien_rotation_matrix[3][3];

void XDB_NEAR xdb_alien_transform_and_project_probe(void);

#if defined(__WATCOMC__)
#pragma aux xdb_alien_transform_and_project_probe \
