/* Codegen probe for the alien starfield projector and Mode-X writer. */
#include <dos.h>
...
#define XDB_STAR_SHADE_TABLE_OFFSET 0x07d6u
#define XDB_STAR_SEED_OFFSET 0x08d6u
#define XDB_STAR_REMAINING_OFFSET 0x08dau
#define XDB_STAR_CURSORS_OFFSET 0x08dcu
#define XDB_STAR_MATRIX_OFFSET 0x0d4cu
#define XDB_STAR_CAMERA_CELLS_OFFSET 0x0d7cu
#define XDB_STAR_RECORDS_OFFSET 0x1f3au
...
void XDB_NEAR xdb_alien_render_starfield_probe(void);

#if defined(__WATCOMC__)
#pragma aux xdb_alien_render_starfield_probe \
