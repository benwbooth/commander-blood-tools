/* Codegen probe for the alien primary-mesh projection and bucket routine. */
#include <dos.h>
...
void XDB_NEAR xdb_alien_project_primary_mesh_then_render_probe(void);

#if defined(__WATCOMC__)
#pragma aux xdb_alien_project_primary_mesh_then_render_probe \
