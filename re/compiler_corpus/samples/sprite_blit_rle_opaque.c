/* Codegen probe for BLOODPRG 0x004CD6. */
...
#pragma aux sprite_blit_rle_opaque_probe parm [di] modify exact []
#endif

void NEAR sprite_blit_rle_opaque_probe(volatile sprite_slot_probe *record)
{
    const volatile sprite_frame_probe FAR *frame;
