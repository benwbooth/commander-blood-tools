/* Codegen probe for the shared XDB slot-9 scaled-sample-delta method. */
#include <dos.h>
...
i16 near xdb_scaled_sample_delta_probe(method_context near *context);

#if defined(__WATCOMC__)
#pragma aux xdb_scaled_sample_delta_probe \
