...
pub use slot2::{
    ...
    CROOLIS_AUTONOMOUS_RESET_DISTANCE, CROOLIS_SELECTION_RESET_DISTANCE, begin_amer_selection,
    begin_croolis_fade, begin_croolis_selection, begin_scrut_fade, begin_scrut_finish,
    begin_scrut_selection, begin_unreferenced_scrut_active_reset, dispatch_croolis_common,
    dispatch_scrut_common, initialize_or_dispatch_slot2, reset_amer_motion, reset_scrut_selection,
    restart_amer_update, restart_croolis_update, restart_scrut_selection, restart_scrut_update,
    ...
    update_croolis_head, update_croolis_motion, update_croolis_reset_or_camera,
    update_croolis_selection, update_scrut_fade, update_scrut_finish, update_scrut_head,
    update_scrut_motion, update_scrut_reset_or_camera, update_scrut_selection_approach,
    update_scrut_selection_begin, update_scrut_selection_damping, update_scrut_steering,
