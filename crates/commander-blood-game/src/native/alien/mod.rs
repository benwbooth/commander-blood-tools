...
pub use slot2::{
    ...
    AlienCroolisSelectionUpdate, AlienCroolisUpdateHead, AlienSlot2AnimationState,
    AlienSlot2Callback, AlienSlot2Callbacks, AlienSlot2Error, AlienSlot2NodeState,
    AlienSlot2SceneState, AlienSlot2Update, AlienUnreferencedSteeringState,
    CROOLIS_SELECTION_RESET_DISTANCE, begin_amer_selection, begin_croolis_fade,
    begin_croolis_selection, dispatch_croolis_common, initialize_or_dispatch_slot2,
    reset_amer_motion, restart_amer_update, restart_croolis_update, update_amer_common,
