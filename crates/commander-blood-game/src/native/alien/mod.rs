...
pub use slot2::{
    ...
    AlienScrutFadeUpdate, AlienScrutUpdateHead, AlienSlot2AnimationState, AlienSlot2Callback,
    ...
    reset_amer_motion, restart_amer_update, restart_croolis_update, restart_scrut_update,
    ...
    update_croolis_selection, update_scrut_fade, update_scrut_head, update_scrut_motion,
