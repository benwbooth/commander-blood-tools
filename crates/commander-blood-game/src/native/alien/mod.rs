...
pub use slot2::{
    ...
    AlienScrutFinishUpdate, AlienScrutSelectionBeginUpdate, AlienScrutSelectionInit,
    ...
    reset_amer_motion, restart_amer_update, restart_croolis_update, restart_scrut_selection,
    restart_scrut_update, update_amer_common, update_amer_finish, update_amer_head,
