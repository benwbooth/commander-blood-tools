...
pub const SQUARE_CAPS_GLYPHS: [(char, [u8; 8]); 22] = [
    ('A', [0x7F, 0x81, 0x81, 0x81, 0x81, 0xBF, 0x81, 0x81]),
    ('B', [0xFE, 0x02, 0x82, 0xBF, 0x81, 0x81, 0x81, 0xFF]),
    ('C', [0xFE, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0xFF]),
    ('D', [0xFE, 0x03, 0x81, 0x81, 0x81, 0x81, 0x81, 0xFF]),
    ('E', [0xFF, 0x80, 0x80, 0xBF, 0x80, 0x80, 0x80, 0xFF]),
    ('F', [0xFF, 0x80, 0x80, 0xBF, 0x80, 0x80, 0x80, 0x80]),
    ('G', [0xFE, 0x80, 0x80, 0x80, 0x80, 0x81, 0x81, 0xFF]),
    ('H', [0x81, 0x81, 0x81, 0x81, 0xBF, 0x81, 0x81, 0x81]),
    ...
    ('P', [0xFF, 0x81, 0x81, 0x81, 0x81, 0xBF, 0x80, 0x80]),
    ...
    ('Y', [0x81, 0x81, 0x81, 0x81, 0x81, 0xFF, 0x04, 0x04]),
];
