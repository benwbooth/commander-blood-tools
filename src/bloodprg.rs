...
fn opcode_metadata(opcode: u8, handler_file_offset: usize) -> OpcodeMetadata {
    match opcode {
        ...
        vm::OP_TEXT => OpcodeMetadata {
            ...
            notes: "TEXT token shape, dictionary words, line state gates, skip/loop controls, accepted-line b5 active-flag mutation, and subtitle assembly rules are represented in Rust",
        },
...
fn render_target_name(target_offset: u16) -> &'static str {
    match target_offset {
        ...
        RENDER_STRING_OFFSET => "main_font_text_draw_display",
...
pub const KNOWN_SYMBOLS: &[BinarySymbol] = &[
    ...
    BinarySymbol {
        name: "ship_3d_c1_mode1_resolved_compare",
        file_offset: 0x006b8b,
        segment: Some(0x04da),
        offset: Some(0x17eb),
        ds_offset: None,
        kind: "script-vm",
        comment: "C1 mode-1 raw operand 1/2 compare path resolves selector-0x11 target then selector-0x13 record slot",
    },
    BinarySymbol {
    ...
    BinarySymbol {
        name: "main_font_text_draw_display",
        file_offset: 0x003192,
        segment: Some(0x0299),
        offset: Some(0x0202),
        ds_offset: None,
        kind: "presentation",
        comment: "main-font renderer; DS:SI=ASCIIZ text, BX=x, DX=y, AL=color",
    },
    BinarySymbol {
